...
public class TestSimilarityMeasures : IMetaheuristicTester
{
    ...
    public static Task Run()
    {
        ...
        CheckSimilarity(
            new TspSolution(new int[] { 1, 2, 3, 4, 5 }),
            new TspSolution(new int[] { 2, 1 }),
            new TspSolutionSimilarity());
        
        CheckSimilarity(
            new TspSolution(new int[] { 1, 2, 3, 4, 5 }),
            new TspSolution(new int[] { 1, 2, 3 }),
            new TspSolutionSimilarity());
        
        CheckSimilarity(
            new TspSolution(new int[] { 1, 2, 3, 4, 5 }),
            new TspSolution(new int[] { 3, 2, 1 }),
            new TspSolutionSimilarity());
        
        CheckSimilarity(
            new TspSolution(new int[] { 1, 2, 3, 4, 5 }),
            new TspSolution(new int[] { 3, 2, 1 }),
            new TspSolutionSequenceSimilarity());
        
        CheckSimilarity(
            new TspSolution(new int[] { 1, 2, 3, 4, 5 }),
            new TspSolution(new int[] { 5, 4, 3, 2, 1 }),
            new TspSolutionSequenceSimilarity());
        
        CheckSimilarity(
            new TspSolution(new int[] { 1, 2, 3, 4, 5, 6 }),
            new TspSolution(new int[] { 5, 4, 3, 2, 1 }),
            new TspSolutionSequenceSimilarity());
