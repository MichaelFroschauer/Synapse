...
public class TspFitnessEvaluator : IFitnessEvaluator
{
    ...
    public double Evaluate(ISolution solution)
    {
        ...
        // Add the number of crossings as a penalty to the total distance, so that solutions with fewer crossings are preferred,
        // even if they have a slightly longer distance. The weight of the penalty can be adjusted based on how much we
        // want to prioritize fewer crossings over shorter distance.
        // var crossings = _fitness2.Evaluate(solution);
        // return sum + crossings * 1000;
    }
