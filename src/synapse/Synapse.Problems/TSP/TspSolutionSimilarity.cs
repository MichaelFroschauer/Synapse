...
[DisplayInfo(
    "Edge-Based Tour Similarity",
    "Compares two tours based on the number of shared edges, independent of traversal direction."
)]
[ApplicableSolution(typeof(TspSolution))]
public class TspSolutionSimilarity : ISolutionSimilarity
{
    ...
    private static double EdgeBasedSimilarity(int[] tour1, int[] tour2, bool symmetric = true)
    {
        ...
        return (2.0 * common) / (edges1.Count + edges2.Count);
    }
