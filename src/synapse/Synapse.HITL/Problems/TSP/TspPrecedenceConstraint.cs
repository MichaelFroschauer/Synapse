    ...
    ) : IConstraint
{
    ...
    public ISolution? Repair(ISolution solution)
    {
        ...
        // 1) Create an array without the element idxA (length n-1)
        ...
        // 2) Calculate insertion position (after B, where B is shifted by 1 in the ‘temp’ array if idxA < idxB)
        ...
        // 3) Build new tour array of original length and insert val at insertPos
