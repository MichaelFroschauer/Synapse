...
{
    // TODO Probably does not work because the the factory is at a specific index
    // so if not the whole solution is given (just a section) we set the factory to the wrong index ...
