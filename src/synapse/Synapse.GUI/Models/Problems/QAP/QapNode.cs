...
public class QapNode : INotifyPropertyChanged
{
    public int Id { get; }
    public double X { get; set; }      // raw coordinate (from MDS)
    public double Y { get; set; }      // raw coordinate (from MDS)
    ...
    public QapNode(int id, double x, double y)
    {
        Id = id;
        X = x;
        Y = y;
